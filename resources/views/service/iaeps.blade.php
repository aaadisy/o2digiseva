        ...
        <div class="col-sm-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{route('iaepstransaction')}}" method="post" arget="_blank">
                        {{ csrf_field() }}
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="md-radio m-b-0">
                                            <input autocomplete="off" type="radio" value="16" id="Withdrawal" name="service" checked="">
                                            <label for="Withdrawal">Withdrawal</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="md-radio m-b-0">
                                            <input autocomplete="off" type="radio" value="15" id="Balance" name="service">
...
@push('script')
    ...
    <script type="text/javascript">
        var USERSYSTEM, STOCK={}, DT=!1, AEPSURL="{{route('iaepstransaction')}}";
