    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-slate">
                ...
                <h6 class="modal-title">Edit Dispute</h6>
            </div>
            <form id="complaintEditForm" action="{{route('disputestore')}}" method="post">
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('statement/fetch')}}/aepsdisputes/0";
        var onDraw = function() {
        };
        var options = [
            { "data" : "bank",
            ...
            { "data" : "bank",
                render:function(data, type, full, meta){
                    return ``+full.report.txnid+`&nbsp;</br> Number: `+full.report.aadhar+ ` </br>( `+full.report.product+` )`+`</br>Amount:`+full.report.amount;
                }
            },
            ...
            { "data" : "status",
                render:function(data, type, full, meta){
                    ...
                    menu += `<li class="dropdown-header">Setting</li>
                            <li><a href="javascript:void(0)" onclick="editComplaint(`+full.id+`, '`+full.status+`', '`+full.comment+`')"><i class="icon-pencil5"></i> Edit</a></li>`;
                    @endif
