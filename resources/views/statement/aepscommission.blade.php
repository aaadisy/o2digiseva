@extends('layouts.app')
@section('title', "AEPS Commission Statement")
@section('pagetitle',  "AEPS Commission Statement")
...
@php
    ...
    $apidata = DB::table('apis')->where('type','recharge')->get();
    $status['type'] = "Report";
    $status['data'] = [
        "success" => "Success",
        "pending" => "Pending",
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">AEPS Commission Statement</h4>
                </div>
        ...
        var options = [
            ...
            { "data" : "bank",
                render:function(data, type, full, meta){
                    ...
                    {
                        aepstype = full.aepstype;
                    }
                    return `Number - `+full.mobile+`<br>Operator - `+full.bank+`<br>Txnid - `+full.txnid+`<br>AEPS Type - `+full.aepstype;
            ...
            { "data" : "bank",
                render:function(data, type, full, meta){
                    return `GST  - `+`<i class="fa fa-inr"></i> `+full.gst+`<br>TDS - `+`<i class="fa fa-inr"></i> `+full.tds;
                }
            },
            { "data" : "bank",
                render:function(data, type, full, meta){
                    ...
                    return `<i class="fa fa-inr"></i> `+full.amount;
                     ...
                     return `<i class="fa fa-inr"></i> `+full.amount+` / <i class="fa fa-inr"></i> `+full.charge;
                    }
                }
            },
            { "data" : "status",
                render:function(data, type, full, meta){
                    return `<i class="fa fa-inr"></i> `+full.adminprofit;
                }
            },
            { "data" : "status",
                render:function(data, type, full, meta){
                    ...
                    if(full.status == "success" || full.status == "pending"){
                        ...
                        menu += `<li class="dropdown-header">Raise Dispute</li>
                                <li><a href="javascript:void(0)" onclick="dispute(`+full.id+`)"><i class="icon-cogs"></i> Raise Dispute</a></li>`;
                        @endif
                    }
