@extends('layouts.app')
@section('title', "Insurance Statement")
@section('pagetitle',  "Insurance Statement")

@php
    $table = "yes";
    $export = "billpay";

    $billers = App\Model\Provider::whereIn('type', ['insurance'])->get(['id', 'name']);
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Insurance Statement</h4>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('statement/fetch')}}/insurancebillpaystatement/{{$id}}";
        var onDraw = function() {
        };
        var options = [
            { "data" : "name",
            ...
            { "data" : "bank",
                render:function(data, type, full, meta){
                    return `Amount - <i class="fa fa-inr"></i> `+full.amount+`<br>Profit - <i class="fa fa-inr"></i> `+full.profit+`<br>GST - <i class="fa fa-inr"></i> `+full.gst+`<br>TDS - <i class="fa fa-inr"></i> `+full.tds;
                }
            },
            { "data" : "status",
                render:function(data, type, full, meta){
    ...
    function viewUtiid(id){
        $.ajax({
            url: `{{url('statement/fetch')}}/insurancebillpaystatement/`+id,
            type: 'post',
            headers: {
