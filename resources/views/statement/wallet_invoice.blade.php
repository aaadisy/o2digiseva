@extends('layouts.app')
@section('title', "Main Invoice")
@section('pagetitle',  "Main Invoice")
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Main Invoice</h4>
                </div>
                
             <div class="col-sm-12">
                 <form class="form control" method="post" action="{{ route('wallet_invoice') }}" >
                     {{ csrf_field() }}
...
<tr class="total">
<td></td>
<td>Grand Total: ₹ {{$data['amount']+$data['commission']-$data['tds']}}</td>
</tr>
</table>
</div>
    ...
    $("#download").on('click', function(){
        ...
        html2canvas($("#resutprint"), {
            onrendered: function (canvas) {
                ...
                var triggerDownload = $("<a>").attr("href", url).attr("download", "main_invoice.jpeg").appendTo("body");
